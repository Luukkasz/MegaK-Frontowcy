...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".container {\n    padding: 20px;\n    background-color: darkgrey;\n}", "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,0BAA0B;AAC9B","sourcesContent":[".container {\n    padding: 20px;\n    background-color: darkgrey;\n}"],"sourceRoot":""}]);
// Exports
